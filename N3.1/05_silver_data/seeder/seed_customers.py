...
def main():
    ...
    df = df[["customer_id", "zip", "signup_date", "gender", "age_group", "acquisition_channel"]].drop_duplicates()
    df["customer_id"] = df["customer_id"].astype(int)
    assert_unique(df, ["customer_id"], "Customers")
    assert_not_null(df, ["customer_id"], "Customers")
